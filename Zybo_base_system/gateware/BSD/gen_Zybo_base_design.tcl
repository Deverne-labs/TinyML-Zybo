...
proc checkRequiredFiles { origin_dir} {
  ...
  set files [list \
   "./ressources/sources_1/bd/system/system.bd" \
   "./ressources/sources_1/imports/hdl/SyncAsync.vhd" \
   "./ressources/constrs_1/imports/constraints/ZyboZ7_A.xdc" \
   "./ressources/constrs_1/imports/constraints/timing.xdc" \
   "./ressources/constrs_1/imports/constraints/auto.xdc" \
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
   [file normalize "$origin_dir/../IPCores"] \
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "Zybo_base_design"
...
set script_file "gen_Zybo_base_design.tcl"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../IPCores"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/ressources/sources_1/bd/system/system.bd"] \
 [file normalize "${origin_dir}/ressources/sources_1/imports/hdl/SyncAsync.vhd"] \
]
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/ressources/sources_1/bd/system/hdl/system_wrapper.vhd" ]
} else {
...
set file "$origin_dir/ressources/sources_1/bd/system/system.bd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "registered_with_manager" -value "1" -objects $file_obj

set file "$origin_dir/ressources/sources_1/imports/hdl/SyncAsync.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "[file normalize ${origin_dir}/ressources/constrs_1/imports/constraints/ZyboZ7_A.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/ressources/constrs_1/imports/constraints/ZyboZ7_A.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/ressources/constrs_1/imports/constraints/timing.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/ressources/constrs_1/imports/constraints/timing.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/ressources/constrs_1/imports/constraints/auto.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/ressources/constrs_1/imports/constraints/auto.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set obj [get_runs synth_1]
set_property -name "part" -value "xc7z020clg400-1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/home/lbo/Projects/DVR-006-001/Base_system/HW/Zybo_base_design.srcs/utils_1/imports/synth_1" -objects $obj
...
set obj [get_runs impl_1]
set_property -name "part" -value "xc7z020clg400-1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/home/lbo/Projects/DVR-006-001/Base_system/HW/Zybo_base_design.srcs/utils_1/imports/impl_1" -objects $obj
